...
class PmapExecutable(stages.XlaExecutable):
  ...
  def from_hlo(xla_computation,
    ...
    # TODO(yashkatariya): Fix the input handling of arrays that span over
    ...
    if hasattr(pci.backend, "compile_replicated"):
      execute_fun = pci.backend.compile_replicated(
          xla_computation, compile_options, input_indices, in_shardings,
          handle_outs)
  ...
  def from_hlo(name: str,
    ...
    if _allow_compile_replicated and hasattr(backend, "compile_replicated"):
      ...
      unsafe_call = backend.compile_replicated(
          computation, compile_options, input_indices, in_shardings, handle_outs)
      xla_executable = None
    else:
