...
def _get_and_check_in_shardings(args, in_axis_resources, pjit_mesh, in_tree):
  if not _is_unspecified(in_axis_resources):
    pjit_in_shardings = in_axis_resources
  else:
    pjit_in_shardings = None
